  ...
  return (
    <>
      <div className="w-full md:w-full  mt-2 p-5">
        <h3 className="w-[30%] text-2xl font-bold text-center">Blank</h3>
        <div className="flex flex-wrap justify-evenly items-center">
          {visibleData.map((val, id) => (
            <div
              key={id}
              className="w-1/2 mt-2 flex justify-center items-center"
            >
              <div className="w-[70%] border border-black border-solid rounded-md flex justify-evenly items-center">
                <img
                  src={val.image}
                  alt={val.alt}
                  className="w-full h-auto md:w-[200px] py-5 md:h-[250px]"
                />
                <div>
                  <h2>my brand</h2>
                  <h2>my brand name</h2>
