  ...
  return (
    <>
      <div className="w-full md:w-full  mt-2 p-5">
        <h3 className="w-[30%] text-2xl  font-bold text-center ">Contract</h3>
        <div className="flex flex-wrap justify-evenly items-center">
          {visibleData.map((val, id) => (
            <div key={id} className="w-1/2  flex justify-center items-center">
              <div className="w-[70%] p-5 flex justify-center">
                <img
                  src={val.image}
                  alt={val.alt}
                  className="w-full h-auto md:w-[350px] border p-5 rounded-md md:h-[450px]"
                />
              </div>
            </div>
          ))}
