...
function Apply() {
  return (
    <div className="mt-2 p-32">
      <section className="max-w-4xl p-6 mx-auto bg-primary rounded-md shadow-md dark:bg-gray-800 ">
        ...
        <form>
          <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
              <label className="text-white dark:text-gray-200" for="Number">
                Number
              </label>
              <input
                id="Number"
            ...
            <div>
              ...
              <textarea
                id="textarea"
                type="textarea"
                className="block w-full px-4 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
              ></textarea>
            </div>
